...
if __name__ == "__main__":
    ...
    my_result_object = my_bucket_resource.Object(s3_bucket,'ethereum_gas' + date_time + '/avg_gasprice.txt')
    my_result_object.put(Body=json.dumps(average_gas_price.take(100)))               
    my_result_object1 = my_bucket_resource.Object(s3_bucket,'ethereum_gas' + date_time + '/avg_gasused.txt')
